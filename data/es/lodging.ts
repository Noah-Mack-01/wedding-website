import type { Hotel, BulkLodging } from '../types';
...
export const hotels: Hotel[] = [
  {
    ...
    address:
      'Carretera Federal Chetumal-Puerto Juarez Km 298, Playa del Carmen, Q.R. 77710, Mexico',
  ...
  },
  {
    ...
    website:
      'https://www.riu.com/en/hotel/mexico/playa-del-carmen/hotel-riu-palace-mexico/',
    hasGroupRate: false,
  },
  {
    id: '1',
    ...
    address:
      'Carretera Chetumal-Puerto Juarez Km 282, Playa del Carmen, Q.R. 77710, Mexico',
    phone: '+52 998 881 0000',
    website: 'https://www.hotelxcaret.com/',
    hasGroupRate: true,
    groupRateInfo: 'Todo Incluido con acceso a los parques Xcaret',
  },
  {
    id: '6',
...
export const bulkLodging: BulkLodging = {
  title: 'Registro de Hospedaje Grupal',
  description:
    'Interesado en coordinar hospedaje con otros invitados en Playa del Carmen? Registrate abajo y te ayudaremos a organizar reservas grupales en nuestros resorts asociados.',
  googleFormUrl:
    'https://docs.google.com/forms/d/e/1FAIpQLSeXfEiD_H5QCLpYJnNo_86r5GAZrETDKT4TFCm_s-MUONJmIw/viewform',
};
