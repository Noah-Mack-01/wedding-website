...
export default function RegistryPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12 sm:px-6 lg:px-8">
      <PageHeader
        title="Gift Registry"
        subtitle="Contribute to our honeymoon fund"
      />
      ...
      <div className="mb-8 rounded-lg bg-white p-6 shadow-sm text-center">
        <p className="mb-3 text-body text-foreground">
          We are also registered at Bloomingdale&apos;s
        </p>
        <a
      ...
      <div className="rounded-lg bg-white p-8 shadow-sm">
        <p className="mb-8 text-center text-body italic text-foreground">
          ...
          you wish to honor us with a gift, a contribution to our honeymoon fund
