      ...
      <div className="rounded-lg bg-white p-8 text-center shadow-sm sm:p-12">
        ...
        {formattedAmount ? (
          <p className="mb-4 text-body text-foreground">
            ...
            to our honeymoon fund means the world to us.
          </p>
        ) : (
          <p className="mb-4 text-body text-foreground">
            Your contribution to our honeymoon fund means the world to us.
          </p>
        )}

        <p className="mb-8 text-body italic text-foreground">
          We are so grateful to have you celebrate this special time with us.
        </p>
