    ...
    <div className="rounded-lg bg-white p-6 shadow-sm">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-body text-foreground">{address}</p>
        </div>
      ...
      {groupRateInfo && (
        <p className="mt-3 text-body text-foreground">{groupRateInfo}</p>
      )}

      {bookingDeadline && (
        <p className="mt-1 text-body italic text-vibrant-coral">
